...
- [Section 3: GO Analysis](#section-3-go-analysis)
...
> Complete the code below to filter countData to exclude genes
...
To use `gage`, I need two things: - a named vector of DEGs (our geneset
...
```
    ...
    Info: Working in directory /Users/tushakarnani/Desktop/fall 25/BIMM 143/BIMM143_github/lab14 git
...
Cell cycle (mitotic) have the most significant entities p-value. This is
the same as the most significant result I got from the KEGG analysis.
